...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;EACE,mBAAmB;EACnB,8BAA8B;EAC9B,sBAAsB;EACtB,yBAAyB;EACzB,sBAAsB;EACtB,yBAAyB;EACzB,wBAAwB;AAC1B;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;;;EAGE,mBAAmB;AACrB;;AAEA;;;;;;EAME,WAAW;AACb;;AAEA;EACE,aAAa;EACb,yCAAyC;EACzC,wBAAwB;EACxB,6DAA6D;EAC7D,WAAW;;EAEX,aAAa;EACb,sBAAsB;EACtB,8BAA8B;AAChC;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;EACE,0BAA0B;EAC1B,0BAA0B;EAC1B,kBAAkB;EAClB,gBAAgB;AAClB;;AAEA;EACE,WAAW;EACX,kDAAkD;AACpD;;AAEA;EACE,aAAa;EACb,SAAS;EACT,0BAA0B;AAC5B;;AAEA;EACE,OAAO;EACP,aAAa;EACb,kBAAkB;EAClB,WAAW;EACX,0BAA0B;EAC1B,wBAAwB;EACxB,yCAAyC;EACzC,kDAAkD;AACpD;;AAEA;EACE,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,0BAA0B;EAC1B,oDAAoD;AACtD;;AAEA;EACE,OAAO;EACP,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,sBAAsB;EACtB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,yCAAyC;EACzC,gBAAgB;EAChB,mBAAmB;EACnB,iBAAiB;AACnB;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,sBAAsB;EACtB,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;EAChB,sBAAsB;EACtB,iBAAiB;AACnB;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,2BAA2B;EAC3B,YAAY;AACd;;AAEA;EACE,0BAA0B;EAC1B,WAAW;AACb;;AAEA,uBAAuB;AACvB;EACE;IACE,WAAW;EACb;AACF","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Electrolize&family=Nova+Mono&family=PT+Mono&family=Quicksand:wght@500\");\n\n:root.default-theme {\n  --main-color: black;\n  --background-color: whitesmoke;\n  --accent-color: tomato;\n  --accent-color-two: white;\n  --active-color: tomato;\n  --active-color-two: white;\n  --inactive-color: silver;\n}\n\nhtml {\n  margin: 0px;\n  padding: 0px;\n}\n\n*,\n*:before,\n*:after {\n  box-sizing: inherit;\n}\n\nh1,\nh2,\nh3,\nh4,\nh5,\nh6 {\n  margin: 0px;\n}\n\nbody {\n  height: 100vh;\n  background-color: var(--background-color);\n  color: var(--main-color);\n  font-family: \"Quicksand\", Tahoma, Geneva, Verdana, sans-serif;\n  margin: 0px;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n\nheader {\n  background-color: var(--background-color);\n}\n\nh1 {\n  font-family: \"Electrolize\";\n  color: var(--accent-color);\n  font-size: x-large;\n  margin: 5px 10px;\n}\n\n.banner {\n  width: 100%;\n  box-shadow: 0px 0px 15px 8px var(--inactive-color);\n}\n\nnav {\n  display: flex;\n  gap: 10px;\n  margin: 7px 10px 10px 10px;\n}\n\nnav button {\n  flex: 1;\n  padding: 10px;\n  border-radius: 7px;\n  border: 0px;\n  font-family: \"Electrolize\";\n  color: var(--main-color);\n  background-color: var(--accent-color-two);\n  box-shadow: 0px 0px 15px 2px var(--inactive-color);\n}\n\nnav button:hover {\n  cursor: pointer;\n  font-weight: bold;\n}\n\nnav button.active {\n  font-weight: bold;\n  color: var(--active-color);\n  box-shadow: 0px 0px 20px 2px var(--active-color-two);\n}\n\ndiv#content {\n  flex: 1;\n  align-self: center;\n}\n\nmain {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin: 10px;\n}\n\ndiv#heading {\n  font-size: larger;\n}\n\ndiv.text {\n  text-align: center;\n  line-height: 1.8;\n  margin: 10px 25px;\n}\n\ndiv.menu-item {\n  align-self: self-start;\n  margin: 10px 25px;\n}\n\ndiv.item-heading {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background-color: var(--accent-color-two);\n  font-size: large;\n  border-radius: 15px;\n  padding: 5px 12px;\n}\n\ndiv.item-name {\n  color: var(--accent-color);\n}\n\ndiv.item-price {\n  font-family: \"PT Mono\";\n  font-size: small;\n}\n\ndiv.item-description {\n  font-size: small;\n  padding: 5px 12px;\n}\n\ndiv.contact-info {\n  line-height: 1.8;\n  align-self: self-start;\n  margin: 10px 25px;\n}\n\ndiv.contact-info .heading {\n  color: var(--accent-color);\n}\n\n.icon {\n  margin: 25px 0px 35px;\n}\n\nfooter {\n  display: flex;\n  justify-content: center;\n  background-color: lightgray;\n  padding: 5px;\n}\n\nfooter a {\n  font-family: \"Electrolize\";\n  color: gray;\n}\n\n/* For larger screens */\n@media only screen and (min-width: 600px) {\n  main {\n    width: 85vw;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
